...
#ifndef RCPP_alocv_beta_RCPPEXPORTS_H_GEN_
#define RCPP_alocv_beta_RCPPEXPORTS_H_GEN_

#include <RcppArmadillo.h>
#include <Rcpp.h>

namespace alocv_beta {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("alocv.beta", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("alocv.beta", "_alocv_beta_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in alocv.beta");
            }
        }
    }
    ...
    inline arma::mat glmnetALODirect(const arma::mat& X, const arma::mat& y, const arma::sp_mat& beta, const arma::vec& lambda, const double& alpha, const arma::field<arma::uvec>& addList, const arma::field<arma::uvec>& dropList, const int family, const bool intercept) {
        ...
        if (p_glmnetALODirect == NULL) {
            ...
            p_glmnetALODirect = (Ptr_glmnetALODirect)R_GetCCallable("alocv.beta", "_alocv_beta_glmnetALODirect");
        }
    ...
    inline arma::mat multinetExpand(const arma::mat& X, const arma::uword K) {
        ...
        if (p_multinetExpand == NULL) {
            ...
            p_multinetExpand = (Ptr_multinetExpand)R_GetCCallable("alocv.beta", "_alocv_beta_multinetExpand");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_alocv_beta_RCPPEXPORTS_H_GEN_
